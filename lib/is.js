 ...
 *
 * @typedef {string | boolean | number | symbol | undefined | null | bigint} Primitive
 */
...
const PRIMITIVE_TYPES = ["boolean", "number", "symbol", "undefined", "null", "bigint"];
...
/**
 * Returns the input value unchanged. This function is useful when you need to ensure that
 * the type of the input is preserved in the output,
 *
 * @example
 *
 * ```javascript
